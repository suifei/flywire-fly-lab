...
for key, text in [("/*__SUBCIRCUIT__*/", (ROOT / "results/dodge/subcircuit_v3.json").read_text()),
                  ...
                  ("/*__GOMOKU_READOUT__*/", (ROOT / "results/gomoku/readout_v3.json").read_text()),
                  ("/*__GOMOKU_TRAIN__*/", (ROOT / "results/gomoku/train_v3.json").read_text()),
                  ("/*__GOMOKU_PLAY__*/", (ROOT / "results/gomoku/play_v3.json").read_text()),
